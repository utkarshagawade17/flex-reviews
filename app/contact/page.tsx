      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@flexliving.com</p>
                    <p className="text-gray-600">support@flexliving.com</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+44 20 7123 4568</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Shoreditch High Street</p>
                    <p className="text-gray-600">London E1 6JQ, United Kingdom</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Quick Response</h2>
              <div className="flex items-center space-x-3 mb-4">
                <MessageCircle className="w-6 h-6 text-purple-500" />
                <span className="font-medium text-gray-900">Live Chat Available</span>
              </div>
              <p className="text-gray-600 mb-4">
                Get instant answers to your questions through our live chat feature. Available 24/7 for urgent inquiries.
              </p>
