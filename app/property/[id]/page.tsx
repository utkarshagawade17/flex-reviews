...
export default function PropertyPage() {
  ...
  const fetchApprovedReviews = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/reviews/approved?listingId=${propertyId}`);
  ...
  const property = {
    ...
    description: 'Beautiful 2-bedroom apartment in the heart of Shoreditch. This modern property offers stunning views of the city and is perfectly located for exploring London\'s vibrant East End. The apartment features contemporary design, high-end finishes, and all the amenities you need for a comfortable stay.',
  };
