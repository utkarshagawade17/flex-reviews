...
import { Star, MapPin, Wifi, Car, Coffee, ChefHat, Dumbbell, Waves, Shield, Tv, AirVent } from 'lucide-react';
...
export default function PropertyPage() {
    ...
    try {
      ...
      if (data.success) {
        ...
        const propertyReviews = data.data.filter((review: NormalizedReview) => 
          review.listingName.includes('Camden Square') || 
  ...
  // Mock property data for Camden Square
  const property = {
    id: propertyId,
    ...
    description: 'Stylish 1-bedroom apartment in the heart of Camden. This vibrant property is perfect for exploring London\'s music scene and markets. The apartment features modern amenities, comfortable living spaces, and easy access to Camden Market, Regent\'s Park, and the London Underground.',
  };
