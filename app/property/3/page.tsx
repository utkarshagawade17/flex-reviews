...
import { Star, MapPin, Wifi, Car, Coffee, ChefHat, Dumbbell, Waves, Shield, Tv, AirVent, TreePine } from 'lucide-react';
...
export default function PropertyPage() {
    ...
    try {
      ...
      if (data.success) {
        ...
        const propertyReviews = data.data.filter((review: NormalizedReview) => 
          review.listingName.includes('Notting Hill') || 
  ...
  // Mock property data for Notting Hill
  const property = {
    id: propertyId,
    name: '3B N3 C - 42 Notting Hill',
    ...
    description: 'Luxurious 3-bedroom apartment in the prestigious Notting Hill area. This stunning property offers the perfect blend of classic London charm and modern luxury. Located near Portobello Road Market, Hyde Park, and Kensington Palace, this apartment provides an exceptional base for exploring London\'s most desirable neighborhoods.',
  };
